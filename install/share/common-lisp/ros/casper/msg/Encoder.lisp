...
(cl:defmethod cl:initialize-instance :after ((m <Encoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name casper-msg:<Encoder> is deprecated: use casper-msg:Encoder instead.")))
...
(cl:defmethod Current-val ((m <Encoder>))
...
(cl:defmethod Encoder1-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader casper-msg:Encoder1-val is deprecated.  Use casper-msg:Encoder1 instead.")
  (Encoder1 m))

(cl:ensure-generic-function 'Encoder2-val :lambda-list '(m))
(cl:defmethod Encoder2-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader casper-msg:Encoder2-val is deprecated.  Use casper-msg:Encoder2 instead.")
  (Encoder2 m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Encoder>)))
  ...
  "9684e83a0d0addb6c2e31639cbbdce64")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Encoder)))
  "Returns md5sum for a message object of type 'Encoder"
  "9684e83a0d0addb6c2e31639cbbdce64")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Encoder>)))
  ...
  (cl:format cl:nil "Header header~%float64 Current~%float64 Encoder1~%float64 Encoder2~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Encoder)))
  "Returns full string definition for message of type 'Encoder"
  (cl:format cl:nil "Header header~%float64 Current~%float64 Encoder1~%float64 Encoder2~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
